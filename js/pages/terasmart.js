...
(function(){
  ...
  function montar(){
    ...
    function placa(){
      ...
      var dados = [
        { a: 0,             t:'Leitura do solo 24h',        d:'Os seis parametros do solo acompanhados sem interrupcao em cada setor de cultivo.' },
        ...
        { a: 3*Math.PI/4,   t:'Dosagem de nutrientes',      d:'Cada nutriente entra na medida prevista pela receita do estagio, sem preparo manual de calda.' },
        ...
        { a: -Math.PI/2,    t:'Consumo por setor',          d:'Cada setor fecha a propria conta de agua e de adubo, sem anotacao do produtor.' },
