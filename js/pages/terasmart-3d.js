...
(function() {
    ...
    // --- NÚMEROS DA VITRINE ---
    // Valores ILUSTRATIVOS, escolhidos só para a animação do gêmeo digital ter
    // um consumo plausível na tela. NÃO são a receita do produto, nem as vazões
    // de projeto, nem a tabela de preços de fornecedor — nada disso vive no
    // site. Se um dia alguém quiser "corrigir para os valores reais": não. É
    // justamente essa tabela que não pode ficar pública.
    const duracaoCicloMin = 12; // duração encenada de um ciclo, em minutos
    const LIQUIDOS = {
        agua:  { nome: 'Água',        vazaoLmin: 6.00, precoL: 0.02, capacidadeL: 1000 },
        a:     { nome: 'Nutriente A', vazaoLmin: 0.25, precoL: 6.00, capacidadeL: 20 },
        b:     { nome: 'Nutriente B', vazaoLmin: 0.25, precoL: 7.00, capacidadeL: 20 },
        c:     { nome: 'Nutriente C', vazaoLmin: 0.25, precoL: 9.00, capacidadeL: 20 },
    };
